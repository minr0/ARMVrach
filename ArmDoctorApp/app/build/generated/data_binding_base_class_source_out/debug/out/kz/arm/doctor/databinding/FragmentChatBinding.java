...
public final class FragmentChatBinding implements ViewBinding {
  ...
  private FragmentChatBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnSend,
      @NonNull LinearLayout emptyView, @NonNull TextInputEditText etMessage,
      @NonNull RecyclerView recyclerView, @NonNull TextInputLayout tilMessage) {
  ...
  public static FragmentChatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentChatBinding((LinearLayout) rootView, btnSend, emptyView, etMessage,
          recyclerView, tilMessage);
    }
